...
class JsonDeserializerSpec extends SerializingBaseSpec {
  ...
  "The json deserializer" should "fail on invalid text messages" in {
    List(
      """  { noscan """,
      """["invalid",noscan] """,
      """[null,""",
      ...
      a[DeserializeException] mustBe thrownBy(s.deserialize(single(text)))
    }
  }
  ...
  it should "fail on invalid HELLO text messages" in {
    List(
      ...
      """[1,"myrealm",null]""",
      """[1,"myrealm",{}]"""",
      """[1,"myrealm",{"INVALID":null}]"""",
      """[1,"myrealm",{"roles":null}]"""",
      """[1,"myrealm",{"roles":{}}]"""",
      """[1,"myrealm",{"roles":{"invalid":{}}}]"""",
  ...
  it should "deserialize a valid HELLO text message" in {
    s.deserialize(single("""[1,"myrealm",{"roles":{"caller":{"features":{"caller_identification":true,"progressive_call_results":true}},"callee":{"features":{"caller_identification":true,"pattern_based_registration":true,"shared_registration":true,"progressive_call_results":true,"registration_revocation":true}},"publisher":{"features":{"publisher_identification":true,"subscriber_blackwhite_listing":true,"publisher_exclusion":true}},"subscriber":{"features":{"publisher_identification":true,"pattern_based_subscription":true,"subscription_revocation":true}}}}]""")) match {
      case msg: Hello =>
        msg.realm mustBe "myrealm"
  ...
  it should "deserialize a valid WELCOME text message" in {
    s.deserialize(single("""[2,9007199254740992,{"roles":{"broker":{}}}]""")) match {
      case msg: Welcome =>
  ...
  it should "deserialize a valid ABORT text message" in {
    s.deserialize(single("""[3, {"message": "The realm does not exist."},"wamp.error.no_such_realm"]""")) match {
      case message: Abort =>
  ...
  it should "deserialize a valid GOODBYE text message" in {
    s.deserialize(single("""[6,{"message": "The host is shutting down now."},"akka.wamp.system_shutdown"]""")) match {
      case msg: Goodbye =>
  ...
  it should "deserialize a valid ERROR text message" in {
    s.deserialize(single("""[8,34,9007199254740992,{},"wamp.error.no_such_subscription"]""")) match {
      case msg: Error =>
  ...
  it should "deserialize a valid PUBLISH text message" in {
    s.deserialize(single("""[16,9007199254740992,{"acknowledge":true},"myapp.topic"]"""")) match {
      case msg: Publish =>
        msg.requestId mustBe 9007199254740992L
  ...
  it should "deserialize a valid PUBLISHED text message" in {
    s.deserialize(single("""[17,9007199254740988,9007199254740992]""")) match {
      case p: Published =>
  ...
  it should "deserialize valid SUBSCRIBE text message" in {
    s.deserialize(single("""[32,9007199254740992,{},"myapp.topic"]""")) match {
      case msg: Subscribe =>
        msg.requestId mustBe 9007199254740992L
  ...
  it should "deserialize a valid SUBSCRIBED text message" in {
    s.deserialize(single("""[33,9007199254740977,9007199254740992]""")) match {
      case msg: Subscribed =>
  ...
  it should "deserialize a valid UNSUBSCRIBE text message" in {
    s.deserialize(single("""[34,9007199254740955,9007199254740992]""")) match {
  ...
  it should "deserialize a valid UNSUBSCRIBED text message" in {
    s.deserialize(single("""[35,9007199254740992]""")) match {
  ...
  it should "deserialize a valid EVENT text message" in {
    s.deserialize(single("""[36,9007199254740933,9007199254740992,{}]""")) match {
      case msg: Event =>
  ...
  it should "deserialize a valid REGISTER text message" in {
    s.deserialize(single("""[64,9007199254740992,{},"myapp.procedure1"]""")) match {
      case msg: Register =>
        msg.requestId mustBe 9007199254740992L
        msg.options mustBe empty
  ...
  it should "deserialize a valid REGISTERED text message" in {
    s.deserialize(single("""[65,9007199254740977,9007199254740992]""")) match {
      case msg: Registered =>
        msg.requestId mustBe 9007199254740977L
  ...
  it should "deserialize a valid UNREGISTER text message" in {
    s.deserialize(single("""[66,9007199254740955,9007199254740992]""")) match {
      case msg: Unregister =>
        msg.requestId mustBe 9007199254740955L
        msg.registrationId mustBe 9007199254740992L
      case msg =>
  ...
  it should "deserialize a valid UNREGISTERD text message" in {
    s.deserialize(single("""[67,9007199254740992]""")) match {
  ...
  it should "deserialize a valid CALL text message" in {
    s.deserialize(single("""[48,9007199254740992,{},"myapp.procedure"]"""")) match {
      case msg: Call =>
        msg.requestId mustBe 9007199254740992L
        msg.options mustBe empty
  ...
  it should "deserialize a valid INVOCATION text message" in {
    s.deserialize(single("""[68,1,1,{}]"""")) match {
      case msg: Invocation =>
  ...
  it should "deserialize a valid YIELD text message" in {
    s.deserialize(single("""[70,1,{}]"""")) match {
      case msg: Yield =>
        msg.requestId mustBe 1
  ...
  it should "deserialize a valid RESULT text message" in {
    s.deserialize(single("""[50,1,{}]"""")) match {
      case msg: Result =>
        msg.requestId mustBe 1
        msg.details mustBe Dict()
      case msg =>
